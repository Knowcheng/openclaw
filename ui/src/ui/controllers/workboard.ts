...
/** Link relationship kinds between cards. */
export const WORKBOARD_LINK_TYPES = ["blocks", "blocked_by", "relates_to"] as const;
/** Verification proof states attached to cards. */
...
/** Optional card metadata collections and derived state. */
...
/** Start a card-linked session and update execution metadata. */
