...
/** Sends a guarded POST request for transcription uploads. */
...
/** Sends a guarded JSON POST request for provider APIs. */
...
/** Sends a guarded multipart POST request for provider APIs. */
