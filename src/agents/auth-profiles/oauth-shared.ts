...
/** Checks whether an incoming OAuth identity can overwrite stored persisted identity. */
...
/** Checks whether bootstrap OAuth import can adopt an existing profile identity. */
